<template>
  <div>
    <div v-if="!hideHeader" class="header">
      <img
        class="header-img"
        :src="getImageSrc('printer.png', true)"
    ...
    <div class="tabs">
      ...
      <div
        class="tab"
        :class="{ 'active-tab': activeTab === '2022' }"
        @click="setActiveTab('2022')"
      >
        2022
      </div>
      <div
        class="tab"
        :class="{ 'active-tab': activeTab === '2021' }"
        @click="setActiveTab('2021')"
      >
        2021
      </div>
    </div>
  ...
  data() {
    return {
      ...
      publications: [
        ...
        {
          title:
            "Invasi Rusia ke Ukraina pada 2022 dalam Perspektif Hukum Internasional",
        ...
        {
          title:
            "Natalitas dan Isu Lingkungan : Respon UNFCCC Terhadap Lonjakan Natalitas di Brasil yang Mengakibatkan Deforestasi di Amazon",
        ...
        {
          title:
            "The Importance of Cyber Security Awareness: COVID-19 Case Study Analysis",
        ...
        {
          title:
            "Sistem Nilai Tukar Mengambang: Studi Kasus Krisis Finansial Asia 1998",
